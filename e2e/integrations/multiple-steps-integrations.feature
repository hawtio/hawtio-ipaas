...
Feature: Test to verify advanced integration with multiple steps
  ...
  Scenario: Create integration with multiple steps
    ...
    And she defines integration name "Multiple steps integration"
    And click on the "Save as Draft" button
    Then Camilla is presented with the Syndesis page "Integrations"
    And Integration "Multiple steps integration" is present in integrations list

    When Camilla deletes the "Multiple steps integration" integration
    Then Camilla can not see "Multiple steps integration" integration anymore